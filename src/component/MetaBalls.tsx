...
import "./MetaBalls.css"; // Make sure you have styles here

// Parse hex string like "#aabbcc" into normalized RGB array
...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    // Pre-fill array with 50 zero vec3s
